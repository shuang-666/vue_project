<template>
  <div class="password_box">
    ...
    <div class="password_header">
      <div></div>
      <div class="password_pas">设置密码</div>
      <div class="password_tongguo" @click="skip">跳过</div>
    </div>
    <!-- 内容 -->
    <div class="password_content">
      <input class="pass_input" type="password" placeholder="请设置登录密码" v-model="pwd" />
      <input class="pass_input" type="password" placeholder="请再次输入密码" v-model="pwds" />
    </div>
    <!-- button按钮 -->
    <div class="login">
      <span @click="password">确定</span>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.sms_code = this.$route.query.sms_code;
  },
  methods: {
    //   点击确定
    password() {

  ...
  <div class="mywk__calendar">
    ...
    <div class="calendar">
      <div class="calendar__header">
        <div class="header__title">{{ selectedYear }}年{{ selectedMonth + 1 }}月</div>
        <div class="wdw_change">
      ...
      <div class="calendar__main">
        ...
        <div
          :class="
            `main__block ${item.content === selectedDate &&
              'main__block-today'}`
          "
          @click="handleDayClick(item)"
          v-for="(item, index) in displayDaysPerMonth(
            selectedYear,
            selectedMonth
          )"
